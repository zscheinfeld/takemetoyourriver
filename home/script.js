...
function initMap() {
  ...
  marker.addListener("mouseover", () => {
    $('.picture').prepend('<img src="/Images/1.JPG"/>')
    console.log("hover")
  });
  ...
  marker1115120.addListener("mouseover", () => {
    $('.picture').prepend('<img src="/Images/2.JPG"/>')
    console.log("hover")
  });
  ...
  marker1114500.addListener("mouseover", () => {
    $('.picture').prepend('<img src="/Images/3.JPG"/>')
    console.log("hover")
  });
  ...
  marker01115098.addListener("mouseover", () => {
    $('.picture').prepend('<img src="/Images/5.JPG"/>')
    console.log("hover")
  });
  ...
  marker1116500.addListener("mouseover", () => {
    $('.picture').prepend('<img src="/Images/4.JPG"/>')
    console.log("hover")
  });
